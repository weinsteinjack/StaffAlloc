...
// Helper component for status badges to keep the table clean
...
export default function ProjectListView() {
  // For MVP, we use mock data directly.
  // In a real app, you would use useEffect to fetch data.
          ...
          <main className="p-6">
            ...
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                <p className="mt-1 text-sm text-gray-500">Manage project staffing plans and allocations</p>
              </div>
              <button
                type="button"
            ...
            <div className="flex items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-x-4">
                    ...
                    <button type="button" onClick={handleClearFilters} className="text-sm font-medium text-blue-600 hover:text-blue-800">
                        Clear filters
                    </button>
                </div>
            </div>
