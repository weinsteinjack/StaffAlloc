...
const ProjectsPageHeader: React.FC = () => (
  <div className="flex flex-col md:flex-row justify-between md:items-start gap-4 mb-6">
    ...
    <div className="flex items-center gap-3 w-full md:w-auto">
      <SearchInput placeholder="Search..." className="flex-grow md:w-auto" />
...
const FilterBar: React.FC = () => (
  <div className="flex flex-col md:flex-row items-start md:items-center gap-4 mb-6">
    <SearchInput placeholder="Search projects..." className="w-full md:w-auto md:flex-grow max-w-xs" />
...
const ProjectTable: React.FC<ProjectTableProps> = ({ projects }) => {
  const standardProjects = projects.slice(0, 8);
  const specialProject1 = projects[8];
  const specialProject2 = projects[9];
      ...
      <table className="w-full text-sm text-left text-gray-600">
        ...
        <tbody className="divide-y divide-gray-200">
          ...
          <tr className="hover:bg-gray-50 transition-colors">
            <td className="px-4 py-4 whitespace-nowrap">
              <div>
                <a href="#" className="font-semibold text-blue-600 hover:underline">{specialProject1.name}</a>
              </div>
            </td>
            <td className="px-4 py-4 whitespace-nowrap text-gray-800">{specialProject1.client}</td>
            <td className="px-4 py-4 whitespace-nowrap text-center"><ManagerCell manager={specialProject1.manager} /></td>
            <td className="px-4 py-4 whitespace-nowrap text-gray-800 text-center">{specialProject1.sprints}</td>
            <td className="px-4 py-4 whitespace-nowrap text-center">{specialProject1.status}</td>
            <td className="px-4 py-4 whitespace-nowrap text-center">
              <button className="text-gray-500 hover:text-gray-800 p-1 rounded-full hover:bg-gray-100" aria-label="More options">
                <MoreHorizontal size={20} />
              </button>
          ...
          {/* Special Row 2 with Pagination */}
          <tr className="hover:bg-gray-50 transition-colors">
            <td className="px-4 py-4 whitespace-nowrap">
              <div>
                <a href="#" className="font-semibold text-blue-600 hover:underline">{specialProject2.name}</a>
              </div>
            </td>
            <td className="px-4 py-4 whitespace-nowrap text-gray-800">{specialProject2.client}</td>
            <td className="px-4 py-4 whitespace-nowrap text-center"><ManagerCell manager={specialProject2.manager} /></td>
            <td className="px-4 py-4 whitespace-nowrap text-gray-800 text-center">{specialProject2.sprints}</td>
